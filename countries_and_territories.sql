...
FROM countries
GROUP BY name
HAVING population > 100000000 AND percent_of_world_pop > 2;

SELECT name, population,
    CASE 
        WHEN population > 100000000 THEN "muito populoso"
        WHEN population > 10000000 THEN "populoso"
        WHEN population > 1000000 THEN "normal"
        WHEN population > 100000 THEN "pouco populoso"
        ELSE "desabitado"
    END as "densidade"
FROM countries;
